...
export function Navbar() {
  ...
  return (
    <header
      // Importante: sin 'sticky' ni 'fixed' aquí; el padre ya es fixed.
      className="
        bg-background/95 supports-[backdrop-filter]:bg-background/60 backdrop-blur
        border-b h-[var(--navbar-h)] w-full py-2
      "
      role="banner"
    >
      <div className="flex items-center h-full px-4">
        ...
        <div className="flex flex-row items-center gap-2 min-w-0">
          <Image
            src="https://raw.githubusercontent.com/t-saturn/resources/mdk/img/logo.png"
            alt="Logo"
            width={32}
            height={32}
            ...
            priority
          />
          <p className="font-bold text-xl truncate">Documentación</p>
        </div>
